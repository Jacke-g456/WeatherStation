# Internet of Things (IoT) Template - Weather Station

### Description
The hardware incorparate the use of various sensors to take measurements of air temperature, heatindex, humidity, air pressure, altitude and soil moisture. It publishes thes parameters to the topic subscribed to by the backend and frontend
...
The role of the frontend is to showcase real-time visualization of data generated by the environmental monitoring sensors, and the ability to visualize as well as perform statistical analysis on the data stored in the database.
